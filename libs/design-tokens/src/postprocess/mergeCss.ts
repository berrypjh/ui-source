 ...
 *
 * 입력(예상 경로)
 * - `{distCssDirAbs}/light/variables.css`
 * - `{distCssDirAbs}/dark/variables.css`
 *
 * 출력(생성 파일)
 * - `{distCssDirAbs}/variables.light.css` : light 테마 변수만 flat 파일로 복사
 * - `{distCssDirAbs}/variables.dark.css`  : dark 테마 변수만 flat 파일로 복사
 * - `{distCssDirAbs}/variables.css`       : light + dark를 개행(`\n`)으로 연결한 최종 병합본
 *
